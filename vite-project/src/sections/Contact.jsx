...
const contactInfo = [

    {
        icon: Mail,
        label: "Email",
        value: "aydengallant2@gmail.com",
        href: "mailto:aydengallant2@gmail.com",
    },
...
export const Contact = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        setFormData({name:"", email: "", message: ""});
            ...
            setSubmitStatus({
                type: "error",
                message: error?.text || error?.message || "Email failed."
            }); 
        } finally {
            setIsLoading(false);
        }
    ...
    <section id="contact" className="py-32 relative overflow-hidden">
        ...
        <div className="container mx-auto px-6 relative z-10">
            ...
            <div className="grid lg:grid-cols-2 gap-12 max-w-5xl mx-auto">
                <div className="glass p-8 rounded-3xl border border-primary/60 animate-fade-in animate-delay-300">
