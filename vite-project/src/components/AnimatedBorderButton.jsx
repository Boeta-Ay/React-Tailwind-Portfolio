    ...
    return(
        ...
        <button className="relative bg-transparent border border-border text-foreground hover:border-primary/50
                           transition-all duration-1000 focus:outline-none focus-visible:ring-2
                            ...
                            {/* Animated SVG Border */}
                            <svg className="absolute left-0 top-0 w-full h-full pointer-events-none download-cv-svg"
                                 viewBox="0 0 200 60"
                            ...
                            >
                                <path 
                                  d="M 30, 1 A 29, 29 0 0 0 1, 30 L1, 30 A 29, 29 0 0 0 30, 59 L 170, 59 A 29, 29 0 0 0 199, 30 A 29, 29 0 0 0 170, 1 Z"
                                  fill="none"
